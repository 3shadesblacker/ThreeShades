...
namespace DBContext.Migrations
{
    ...
    [Migration("20230723140927_DefaultDutyStateAndCommentModel")]
    partial class DefaultDutyStateAndCommentModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataModels.CommentModel", b =>
                {
                    b.Property<int>("Key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataModels.CommentModel", b =>
                {
                    b.HasOne("DataModels.DutyModel", "Duty")
                        .WithMany()
                        .HasForeignKey("DutyKey")
